...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 w-full z-30 transition-all duration-500 px-6 md:px-8 py-3 md:py-5 flex justify-between items-center ${
          isHome
      ...
      >
        ...
        <div className="md:hidden">
          <button onClick={() => setIsOpen(true)}>
            <FiMenu
              size={32}
              className="text-[#f4e9dc] hover:text-[#876e4B] border border-[#f4e9dc] hover:border-[#876e4B] rounded-md p-1 transition-colors duration-200"
            />
          </button>
        </div>
      </nav>
