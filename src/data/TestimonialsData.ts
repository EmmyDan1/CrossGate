...
export const testimonials: Testimonial[] = [
  ...
  {
    id: 3,
    role: 'Logistics Manager (Estonia)',
    name: 'Kristjan Tamm',
    content: 'Their real-time documentation system reduced our cargo delays by 75%. Finally, a platform that understands cross-continent shipping.',
  ...
  },
  {
    id: 5,
    name: 'Erik Johansen',
    role: 'Renewable Energy CEO (Denmark)',
    content: 'Sourced high-quality solar panel components from Kenya in half the usual time. Their verification system builds instant trust.',
